...
export function CourseLLMBasics({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="llm-basics" icon={'\uD83E\uDDE0'} title="How LLMs Work" timeMinutes={45} exerciseCount={8} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
    if(d==='visionary'){
...
export function CoursePromptEng({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="prompt-engineering" icon={'\uD83D\uDCAC'} title="Prompt Engineering" timeMinutes={40} exerciseCount={10} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
    if(d==='visionary'){
...
export function CourseEmbeddings({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="embeddings" icon={'\uD83D\uDD0E'} title="Embeddings & Vector Search" timeMinutes={35} exerciseCount={6} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
    if(d==='visionary'){
...
export function CourseRAG({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="rag-fundamentals" icon={'\uD83D\uDD0D'} title="RAG Fundamentals" timeMinutes={50} exerciseCount={9} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
    if(d==='visionary'){
...
export function CourseContextEng({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="context-engineering" icon={'\uD83E\uDDE9'} title="Context Engineering" timeMinutes={40} exerciseCount={7} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
...
export function CourseAISafety({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="ai-safety" icon={'\uD83D\uDEE1\uFE0F'} title="AI Safety & Alignment" timeMinutes={35} exerciseCount={6} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
...
export function CourseTokensCosts({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="tokens-costs" icon={'\uD83D\uDCB0'} title="Tokens, Costs & Model Selection" timeMinutes={30} exerciseCount={5} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
...
export function CourseJSONMode({onBack,onNavigate,progress,onComplete,depth,onChangeDepth}){
  ...
  return <CourseShell id="json-mode" icon={'\uD83D\uDCCB'} title="JSON Mode & Structured Outputs" timeMinutes={35} exerciseCount={7} onBack={onBack} onNavigate={onNavigate} progress={progress} onComplete={onComplete} depth={depth} onChangeDepth={onChangeDepth} visionaryTabs={visionaryTabs} deepTabs={deepTabs} renderTab={(tab,i,d)=>{
