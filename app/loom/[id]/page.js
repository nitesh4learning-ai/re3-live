...
export const metadata = {
  ...
  description: 'Deep-dive into a Re³ synthesis cycle. Explore connected posts across three intellectual lenses with through-line questions and emergent insights.',
};
    ...
    <>
      ...
      <noscript>
        <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
          ...
          across three intellectual lenses with through-line questions and emergent insights.</p>
