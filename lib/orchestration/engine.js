...

{
  ...
  "blueprint": {
    "sequence_diagram": "A complete Mermaid.js sequence diagram (sequenceDiagram\\n ...) showing step-by-step interaction between the user, AI orchestration layer, and external data sources. Use proper Mermaid syntax.",
    "erd": "A complete Mermaid.js entity-relationship diagram (erDiagram\\n ...) defining the core data objects and their relationships for this use case. Use proper Mermaid syntax.",
    "technical_constraints": ["Constraint or API integration recommendation 1", "Constraint 2", "..."],
    "api_integrations": ["Recommended API/service 1 with brief rationale", "API 2", "..."]
  },
  "prototype": {
    "component_name": "PascalCase component name",
    "description": "What this prototype demonstrates",
    "code": "A complete single-file React component using Tailwind CSS for styling. The component MUST: (1) be fully self-contained with no imports except React, (2) use Tailwind utility classes for all styling, (3) have interactive elements (clickable buttons, working tabs, or simulated data), (4) include a Status or Analytics section reflecting the orchestration data points, (5) use useState for interactivity. Export as default. Keep under 200 lines."
  },
  "recommendations": ["Key recommendation 1", "Recommendation 2", "..."],
  "full_report": "The full markdown narrative integrating all agent outputs (executive summary, analysis sections, conclusions)"
}

CRITICAL RULES:
- The Mermaid diagrams must use valid Mermaid.js syntax. Test mentally that they would render.
- The React component must be valid JSX that works standalone. Use only React.useState, no other imports.
