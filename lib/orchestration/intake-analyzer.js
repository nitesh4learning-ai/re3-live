...
const TYPE_KEYWORDS = {
  "competitive-analysis": [
    "competitive", "competitor", "market", "landscape", "positioning",
    "industry", "benchmark", "swot", "market share", "rivalry",
    "players", "entrants", "moat", "differentiation",
  ],
  "communication-plan": [
    "communication", "stakeholder", "messaging", "audience", "outreach",
    "announcement", "narrative", "tone", "internal comms", "press",
    "engagement", "campaign", "branding", "public relations",
  ],
  "decision-matrix": [
    "decision", "criteria", "scoring", "trade-off", "evaluate",
    "options", "alternatives", "weigh", "pros and cons", "choose",
    "prioritize", "rank", "framework", "assessment",
  ],
  "process-recommendation": [
    "process", "workflow", "optimization", "efficiency", "bottleneck",
    "automation", "streamline", "operations", "improvement", "sop",
    "lean", "kaizen", "procedure", "methodology",
  ],
  "meeting-brief": [
    "meeting", "agenda", "brief", "action item", "minutes",
    "discussion point", "prep", "talking point", "attendee", "recap",
    "pre-read", "summary", "context gathering",
  ],
};
...
Categories:
- competitive-analysis: Market research, competitor analysis, industry benchmarking
- communication-plan: Stakeholder messaging, audience strategy, communication frameworks
- decision-matrix: Criteria evaluation, option scoring, trade-off analysis
- process-recommendation: Workflow optimization, process improvement, operational recommendations
- meeting-brief: Meeting preparation, agenda structuring, context gathering
