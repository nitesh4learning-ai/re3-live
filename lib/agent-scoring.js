...
const TASK_PROFILES = {
  "micro-saas-validator": {
    research: 0.30, critique: 0.25, ideate: 0.20, architect: 0.15, synthesize: 0.10,
  },
  "ai-workflow-blueprint": {
    architect: 0.30, implement: 0.25, research: 0.20, synthesize: 0.15, critique: 0.10,
  },
  "creator-monetization": {
    ideate: 0.30, synthesize: 0.25, research: 0.20, architect: 0.15, debate: 0.10,
  },
  "vertical-agent-design": {
    architect: 0.30, research: 0.25, ideate: 0.20, implement: 0.15, critique: 0.10,
  },
  "growth-experiment": {
    research: 0.25, critique: 0.25, ideate: 0.20, synthesize: 0.15, implement: 0.15,
  },
  // Context as a Frontier — deriving golden context across the six-stage spine.
  // Emphasizes the comprehension capabilities the stages lean on (research,
  // architect, critique, debate) so selectTeam draws a fitting, diverse team.
  "context-comprehension": {
    research: 0.25, architect: 0.25, critique: 0.20, debate: 0.15, synthesize: 0.10, ideate: 0.05,
  },
};
